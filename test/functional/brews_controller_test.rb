...
class BrewsControllerTest < ActionController::TestCase
  ...
  test "should create brew" do
    assert_difference('Brew.count') do
      post :create, brew: { brewer_id: @brew.brewer_id, description: @brew.description, name: @brew.name }
    end
  ...
  test "should update brew" do
    put :update, id: @brew, brew: { brewer_id: @brew.brewer_id, description: @brew.description, name: @brew.name }
    assert_redirected_to brew_path(assigns(:brew))
  end
